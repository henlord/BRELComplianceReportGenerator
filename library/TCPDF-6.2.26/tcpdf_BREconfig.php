...
if (!defined('K_TCPDF_EXTERNAL_CONFIG') OR !K_TCPDF_EXTERNAL_CONFIG) {
	...
	$tcpdf_config_files = array(dirname(__FILE__).'/config/tcpdf_BREconfig.php', '/etc/php-tcpdf/tcpdf_config.php', '/etc/tcpdf/tcpdf_config.php', '/etc/tcpdf_config.php');
...
if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by BRE Housing & Energy");
}
